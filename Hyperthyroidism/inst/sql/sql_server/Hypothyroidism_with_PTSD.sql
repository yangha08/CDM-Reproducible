...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (436676,44836990,1568232)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4342711)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4342711)
  and c.invalid_reason is null
