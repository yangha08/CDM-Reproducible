...
OhdsiRTools::checkUsagePackage("Hyperthyroidism")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/Hyperthyroidism.pdf")
shell("R CMD Rd2pdf ./ --output=extras/Hyperthyroidism.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("Hyperthyroidism")
